...
def translate_opts(parser):
    ...
    # Diverse beam search arguments
    # Algorithm described here: https://arxiv.org/abs/1610.02424
    group.add_argument('-group_size', type=int, default=-1,
                       help="""If beam size is divisible by group size,
                        beam is grouped into sub-beams of this size and
                        diverse beam search is performed""")
    group.add_argument('-diversity_penalty', default='cum',
                       help="Diversity penalty to use")
    group.add_argument('-diversity_factor', type=float, default=0.,
                       help="Constant which controls the degree of diversity")
